...
@section('desc')
    ...
    <!-- s-content
    ================================================== -->
    <section class="s-content s-content--narrow" style="margin-top: -70px" >
        ...
        <div class="row">
            ...
            <div class="s-content__media col-full">
                <div class="s-content__post-thumb">
                    <img src="{{ asset('frontend/images/thumbs/about/1') }}" 
                         srcset="{{ asset('frontend/images/thumbs/about/about-2000.jpg 2000w') }}, 
                                 {{ asset('frontend/images/thumbs/about/about-1000.jpg 1000w') }}, 
                                 {{ asset('frontend/images/thumbs/about/about-500.jpg 500w') }}" 
